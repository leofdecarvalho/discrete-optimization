...
def solve_it(input_data):
    ...
    filename = os.path.join(dir, '.\\..\\..\\target\\discret-optimization-1.0.jar')
    mainClassName = 'coloring.SolverColor';
    process = Popen(['java',
                    '-cp', filename,  mainClassName, '-file=' + tmp_file_name], stdout=PIPE)
